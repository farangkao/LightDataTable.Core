...
namespace Generic.LightDataTable
{
    public class LightDataTable : LightDataTableShared, ILightDataTable
    {
        ...
        /// <param name="position"></param>
        /// <returns></returns>
        public ILightDataTable OrderBy<T, P>(Expression<Func<T, P>> action, bool position) where T : class
        {
        ...
        public void MergeByPrimaryKey(LightDataTableRow rowToBeMerged)
        {
            ...
            FindByPrimaryKey<LightDataTableRow>(rowToBeMerged.TValueAndConvert<string>(_tablePrimaryKey)).Merge(rowToBeMerged);
        }
